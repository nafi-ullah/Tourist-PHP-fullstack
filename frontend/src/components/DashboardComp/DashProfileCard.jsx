    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full mb-4">
            ...
            <div className="flex flex-col items-center mt-4">
                ...
                <div className="text-sm font-bold text-gray-800 mt-2">@{userData.username}</div>
                <div className="text-gray-700 mt-8">{userData.bio}</div>
            </div>
            {/* <!-- Bio --> */}
            
            {/* <!-- Social Links --> */}
            <div className="w-full flex justify-center mt-14 space-x-4">
